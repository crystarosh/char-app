...
# THE V24 CODE (V23 + Missing Helper)
v24_code = r'''def generate_card_zip(char, manager):
    import io
    import zipfile
    import os
    ...
    # --- V24 FIX: Restore Missing Helper ---
    print(f"DEBUG: V24 (Fix load_image_masked) - {char.get('name')}")
    ...
    # --- Debug Mode Maintained (Crash on Error) ---
    i1 = create_card_1()
    i2 = create_card_2()
    i3 = create_card_3()
...
if match:
    new_content = content[:match.start()] + v24_code + "\n\n" + content[match.end():]
