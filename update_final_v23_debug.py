...
# THE V23 CODE (Debug Mode: No Try-Catch)
message = r'''
    # --- V23 FINAL ADJUSTMENTS (Debug Mode) ---
    print(f"DEBUG: V23 - {char.get('name')}")
    
    # ... (Helpers omitted for brevity in variables, but must be included in actual write)
'''

# To ensure I don't miss anything, I will write the FULL function content again.
v23_code_debug = r'''def generate_card_zip(char, manager):
    import io
    import zipfile
    import os
    ...
    # --- NO TRY_EXCEPT: LET IT CRASH FOR DEBUGGING ---
    i1 = create_card_1()
    i2 = create_card_2()
    i3 = create_card_3()
...
if match:
    new_content = content[:match.start()] + v23_code_debug + "\n\n" + content[match.end():]
    with open(target_file, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("V23 Debug Mode Applied.")
else:
