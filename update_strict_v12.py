...
# THE V12 FUNCTION
v12_code = r'''def generate_card_zip(char, manager):
    import io
    import zipfile
    import os
    ...
    def draw_text_wrapped(draw, text, x, y, max_h, max_w, font, fill, align="left"):
        ...
        # Vertical Centering Logic: (Box Height - Text Height) / 2
    ...
    def make_transparent(img):
        # Programmatically convert white pixels to transparent
        datas = img.getdata()
        new_data = []
        for item in datas:
            # Threshold for white (adjust if needed, >230 is safe enough for pure white)
    ...
    def create_card_1():
        ...
        # Font Color Rule: Holy/Other/Human -> #333333, Demon -> White
        # USER REQUEST: "If Holy or background is light -> #333333"
        # Current logic simplified: Only Demon gets White.
        if race == "魔族":
            txt_col = "#FFFFFF"
        else:
            txt_col = "#333333"
        ...
        # Coordinates (110, 110) Size (400, 400)
        ...
        if os.path.exists(t_path):
            ...
            # Ensure template transparency for card 1 too if needed, though usually these are pre-made with holes
            # If user complains about Card 1 overlapping, apply make_transparent here too.
            # But usually Profile templates have transparency.
        ...
        # Box Top: 790, Height: 140 (as per previous logic 790->930 usually)
        # Function: draw_text_wrapped(draw, text, x, y, max_h, max_w, font, fill...)
...
if start_pos != -1 and end_pos != -1:
    ...
    new_content = pre + v12_code + "\n\n" + post
    with open(target_file, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("V12 Strict Update Applied.")
else:
