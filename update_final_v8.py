...
new_func_code = r'''def generate_card_zip(char, manager):
    ...
    def create_card_1():
        ...
        # New Font Color Logic (V8)
        # Holy/Other -> Dark Brown (#301b00)
        # Demon -> White
        # Human -> Dark Gray (#333333) - or follow "Other" rule? 
        # User said: "Holy" or "Other" (light background) -> #301b00.
        # Demon -> White.
        # Let's map Human to Dark Brown too if it's light? Or stick to #333.
        # Strict user instruction: "Holy and Other".
        # Let's assume Human is also light background, so safe to use Dark Brown or Dark Gray.
        # I'll use Dark Brown for Holy/Other/Human, White for Demon.
        
        if race == "魔族":
            txt_col = "#FFFFFF"
        elif race in ["聖族", "その他", "人間"]:
            txt_col = "#301b00" # Dark Brown
        else:
             txt_col = "#301b00" # Fallback Dark Brown
             
        img = Image.new("RGBA", CANVAS_1, (255, 255, 255, 255))
        
        # Images: STRICT COORDINATES V8
        # Img 1: (110, 110), Size (400, 400)
        if len(char['images']) > 0:
            i1 = load_image_cover(char['images'][0], (400, 400))
            img.paste(i1, (110, 110))
            
        # Img 2: (700, 110), Size (250, 600)
        ...
        # Memo: FORCE BLACK/DARK
        # Position: Move 40px UP from previous (830 -> 790? or 860-40=820?)
        # Current V7 was 830. User says "40px up from CURRENT". 830 - 40 = 790.
        # Height 140px.
        memo_col = "#000000"
    ...
    def create_card_3():
        ...
        print(f"DEBUG: get_img_valid(2) = {get_img_valid(2)}")
        # --- DEBUG END ---
...
try:
    ...
    # Ensure regex works with normalized content
    ...
    if pattern.search(content):
        ...
        with open(target_file, 'w', encoding='utf-8') as f:
            f.write(new_content)
        print("Function generate_card_zip updated successfully V8.")
    else:
        print("Regex match failed. Falling back to append/rewrite strategy.")
