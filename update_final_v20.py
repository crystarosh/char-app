...
# THE V20 FUNCTION (Card 2 Layout Adjustment)
v20_code = r'''def generate_card_zip(char, manager):
    import io
    import zipfile
    import os
    ...
    # --- DEBUG ---
    print(f"DEBUG: V20 - Adjusting Bio Layout")
    ...
    def draw_text_wrapped(draw, text, x, y, max_h, max_w, font, fill, align="left"):
        ...
        # V20 CHANGE: REMOVED Vertical Centering to fix "Gap too wide" / "Text too low" issues.
        # old: start_y = y + (max_h - total_h) // 2
        start_y = y 
    ...
    # --- 2. STATS CARD (V20 - Adjusted Bio) ---
    def create_card_2():
        print("DEBUG: Creating Card 2 (V20 Layout)")
        ...
        # V20: MARGIN & POSITION FIX
        # Shift X to 130 to avoid bottom-left corner (0-150)
        # Shift Y of Title: 500 (Kept)
        # Shift Y of Body: 535 (Reduced gap from 60 to 35)
        # Width: 1024 - 130*2 = 764
        ...
        # draw_text_wrapped now does NOT center vertically, it aligns top to 535
        # This solves "Space too wide" (35px simple gap) and "Overlap with corner" (X=130)
        draw_text_wrapped(draw, bio, dx, dy+35, 200, 764, get_font(16), "#212121")
...
if start_pos != -1 and end_pos != -1:
    ...
    new_content = pre + v20_code + "\n\n" + post
    with open(target_file, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("V20 Layout Update Applied.")
else:
