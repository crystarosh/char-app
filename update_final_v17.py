...
# THE V17 FUNCTION
v17_code = r'''def generate_card_zip(char, manager):
    import io
    import zipfile
    import os
    ...
    # --- 2. STATS CARD (REVERT TO V14 - NO CORNER DECOR, RIGHT FOOTER) ---
    def create_card_2():
        print("DEBUG: Creating Card 2 (V14)")
        ...
        # V14 STYLE: Simple border, no corner decorations
...
if start_pos != -1 and end_pos != -1:
    ...
    new_content = pre + v17_code + "\n\n" + post
    with open(target_file, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("V17 Profile Color Update & Card 2 Revert Applied.")
else:
