...
# THE V19 FUNCTION (V18 + Card 2 Footer)
v19_code = r'''def generate_card_zip(char, manager):
    import io
    import zipfile
    import os
    ...
    # --- DEBUG ---
    print(f"DEBUG: V19 - Adding Footer to Card 2")
    ...
    # --- 2. STATS CARD (V18 + Footer) ---
    def create_card_2():
        print("DEBUG: Creating Card 2 (V19 w/ Footer)")
...
if start_pos != -1 and end_pos != -1:
    ...
    new_content = pre + v19_code + "\n\n" + post
    with open(target_file, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("V19 Card 2 Footer Added.")
else:
