...
# THE V21 FUNCTION (V20 + Offset Tweak)
v21_code = r'''def generate_card_zip(char, manager):
    ...
    # --- DEBUG ---
    print(f"DEBUG: V21 - Fine Tuning Bio Gap")
    ...
    def create_card_2():
        ...
        # Changed 35 -> 45 (Opening it up slightly)
...
if start_pos != -1 and end_pos != -1:
    ...
    new_content = pre + v21_code + "\n\n" + post
    with open(target_file, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("V21 Gap Update Applied.")
else:
